...
function planting_seeds(self, Player)
    ...
    -- planting_seed(self, player_position_x, player_position_y)
...
-- function planting_seed(self, player_position_x, player_position_y)
--     local button_c = btnp(5)
--     local is_ground_dirt = mget(player_position_x, player_position_y) == self.dirt_sprite
--     if button_c and is_ground_dirt then
--         printh('inside')
--         printh(self.sprite)
--         mset(player_position_x, player_position_y, self.sprite)
--         add(self.seeds, { sx = flr(player_position_x), sy = flr(player_position_y), itg = 0 })
